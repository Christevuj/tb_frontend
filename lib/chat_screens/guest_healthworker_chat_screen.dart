...
class GuestHealthWorkerChatScreen extends StatefulWidget {
  ...
  const GuestHealthWorkerChatScreen({
    super.key,
  ...
  @override
  State<GuestHealthWorkerChatScreen> createState() =>
      _GuestHealthWorkerChatScreenState();
}

class _GuestHealthWorkerChatScreenState
    extends State<GuestHealthWorkerChatScreen> {
  ...
  void _deleteConversation() async {
    try {
      ...
      await _chatService.deleteConversation(
          widget.guestId, widget.healthWorkerId);
  ...
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      print('❌ GUEST_HEALTHWORKER_CHAT ERROR: Failed to pick/send image');
      print('❌ GUEST_HEALTHWORKER_CHAT ERROR: $e');
      print('❌ GUEST_HEALTHWORKER_CHAT STACK TRACE: $stackTrace');
      ScaffoldMessenger.of(context).hideCurrentSnackBar();
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Container(
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Start a conversation with ${widget.healthWorkerName}',
                          style: TextStyle(
                  ...
                  child: Container(
                    ...
                    child: message.isImage 
                        ? GestureDetector(
                            ...
                            child: Hero(
                              tag: 'guest_healthworker_image_${message.id}',
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(16),
                                child: Image.network(
                                  message.imageUrl!,
