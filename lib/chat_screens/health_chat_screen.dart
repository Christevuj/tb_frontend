  ...
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      if (pickedFile != null) {
        ...
        // Update the health worker status after sending message
        _updateHealthWorkerStatus();
      }
    } catch (e, stackTrace) {
      print('❌ HEALTH_CHAT_SCREEN ERROR: Failed to pick/send image');
      print('❌ HEALTH_CHAT_SCREEN ERROR: $e');
      print('❌ HEALTH_CHAT_SCREEN STACK TRACE: $stackTrace');
      ScaffoldMessenger.of(context).hideCurrentSnackBar();
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Container(
