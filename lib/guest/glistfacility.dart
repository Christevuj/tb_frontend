          ...
          onTap: () {
            if (facilityId != null) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    'No health workers found for ${facility.name}',
                  ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  facilityId != null ? 'Active' : 'No Workers',
                                  style: TextStyle(
                                    fontSize: 10,
                ...
                // Health Workers Count (if facility exists in Firebase)
                if (facilityId != null) ...[
                  ...
                  FutureBuilder<QuerySnapshot>(
                    future: FirebaseFirestore.instance
                        ...
                        .get(),
                    builder: (context, healthWorkerSnapshot) {
                      if (healthWorkerSnapshot.hasData) {
                        final count = healthWorkerSnapshot.data!.docs.length;
                        return Container(
                          padding: const EdgeInsets.symmetric(
