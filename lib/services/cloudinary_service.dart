...
class CloudinaryService {
  ...
  Future<String?> uploadImage({
    ...
    try {
      ...
      debugPrint('[CloudinaryService] File size: ${imageFile.lengthSync()} bytes');
  ...
  Future<String?> uploadImageWithProgress({
    ...
    try {
      debugPrint('[CloudinaryService] Starting image upload with progress tracking...');
  ...
  bool get isConfigured {
    ...
    debugPrint('[CloudinaryService] Configuration check: true (using pbooking1.dart config)');
    return true;
  }
}